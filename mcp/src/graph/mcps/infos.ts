...
export const mcpsInfo: Record<string, MCPServerInfo> = {
  ...
  erc20: {
    client: {
        command: "node",
        args: ["../mcps/erc20/build/index.js"],
        transport: "stdio",
    },
    description: "Gestion des operations avec des ERC20 (transfert, balance, deploiement) sur starknet",
    promptInfo: {
      expertise: "ERC20 sur Starknet",
      tools: [
        'erc20_get_allowance', 
