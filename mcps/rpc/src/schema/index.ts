...
export const blockIdSchema = z.object({
  blockId: z.union([
    z.string().describe("The block identifier. Can be 'latest', 'pending', or a block hash."),
    z.number().describe('A block number.'),
  ]),
});

export const blockIdAndContractAddressSchema = z.object({
  blockId: z.union([
    z.string().describe("The block identifier. Can be 'latest', 'pending', or a block hash."),
    z.number().describe('A block number.'),
  ]),
...
export const getStorageAtSchema = z.object({
  ...
  contractAddress: z.string().describe('The address of the contract'),
  key: z.string().describe('The key to the storage value for the given contract'),
});
...
export const getClassAtSchema = z.object({
  ...
  contractAddress: z.string().describe('The address of the contract'),
  key: z.string().describe('The class for the given contract at the given block'),
});
...
export const getClassHashAtSchema = z.object({
  ...
  contractAddress: z.string().describe('The address of the contract'),
  key: z.string().describe('The class hash for the given contract at the given block need to be a real class hash'),
});
...
export const getTransactionByBlockIdAndIndexSchema = z.object({
  ...
  transactionIndex: z.number().int().nonnegative().describe('The index of the transaction within the block.'),
});

export const transactionHashSchema = z.object({
  transactionHash: z.string().describe('The hash of the requested transaction.'),
});
